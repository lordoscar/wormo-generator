...
$(function () {
  ...
  document
    .querySelector(".division-textarea")
    .addEventListener("keyup", drawImage);
  document
    .querySelector(".title-textarea")
    .addEventListener("keyup", drawImage);
  document.querySelector(".date-textarea").addEventListener("keyup", drawImage);
  document
    .querySelector(".insta-textarea")
    .addEventListener("keyup", drawImage);
  document.querySelector(".fb-textarea").addEventListener("keyup", drawImage);
  document
    .querySelector(".hashtag-textarea")
    .addEventListener("keyup", drawImage);
  document
    .querySelector(".home-team-select")
    .addEventListener("change", drawImage);
  document
    .querySelector(".away-team-select")
    .addEventListener("change", drawImage);
...
function drawImage() {
  ...
  ctx.drawImage(
    ...
    0,
    overlayimg.width,
    overlayimg.height, // source rectangle
    0,
    0,
    canvas.width,
    canvas.height
  ...
  ctx.fillText(
    document.querySelector(".division-textarea").value.toUpperCase(),
    canvas.width / 2,
    (canvas.height / 100) * 8
  );
  ...
  ctx.fillText(
    document.querySelector(".title-textarea").value.toUpperCase(),
    canvas.width / 2,
  ...
  let datex = ctx.measureText(
    document.querySelector(".date-textarea").value.toUpperCase()
  );
  ...
  ctx.fillText(
    document.querySelector(".date-textarea").value.toUpperCase(),
    canvas.width / 2 - stadiumx.width / 2,
    (canvas.height / 100) * 70
  );
  ctx.font = (canvas.height / 100) * 3 + "px Proxima Nova Light";
  ctx.fillText(
    home.stadium.toUpperCase(),
    canvas.width / 2 + datex.width / 2,
    (canvas.height / 100) * 70
  );
  ...
  homeimg.onload = function () {
    ctx.drawImage(
      ...
      homeimg.width,
      homeimg.height,
      canvas.width / 2 - (canvas.width / 100) * 17,
      (canvas.height / 100) * 75,
      (canvas.width / 100) * 13,
      (canvas.height / 100) * 13
    );
  };
  ...
  ctx.drawImage(
    ...
    instaimg.height,
    (canvas.width / 100) * 5,
    (canvas.height / 100) * 85,
    (canvas.width / 100) * 3,
    (canvas.height / 100) * 3
  );

  ctx.font =
    "italic " + (canvas.height / 100) * 2.5 + "px Proxima Nova Semibold";
  ctx.fillText(
    document.querySelector(".insta-textarea").value.toLowerCase(),
    (canvas.width / 100) * 17.8,
    (canvas.height / 100) * 87.5
  );
  ...
  ctx.fillText(
    document.querySelector(".fb-textarea").value.toLowerCase(),
    (canvas.width / 100) * 14.8,
    (canvas.height / 100) * 92.5
  );

  ctx.font = (canvas.height / 100) * 5 + "px Mighty Brush";

  let textx = ctx.measureText(
    document
      .querySelector(".hashtag-textarea")
      .value.replace("#", "")
      .toUpperCase()
  ...
  ctx.fillText(
    "#",
    canvas.width / 2 - textx.width / 2 - 15,
    (canvas.height / 100) * 97
  );
  ...
  ctx.fillText(
    document
      ...
      .value.replace("#", "")
      .toUpperCase(),
    canvas.width / 2 + hashtagx.width / 2,
    (canvas.height / 100) * 97
  );
}
